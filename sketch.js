...
function detectCollisionCollision(lstones,Imango){
...
if(lstones.body.position.x-lmango.body.position.x<lmango.diametre + lstones.diametre
	...
	&&lmango.body.position.y-lmango.body.position.y<lmango.diametre + lstones.diametre
